...
| **Memory / Database** *(Future Phase)* | PostgreSQL + `pgvector` | Managed Relational DB with Vector extension | **Supabase** or **Neon** |
...
- **Region**: Select the region closest to your target users (e.g., *Frankfurt / Oregon / Ohio*).
...
- [ ] **Web Search Tool**: Ask a live question (e.g., *"What is the weather today in Tokyo?"*); confirm Tavily search tool executes and returns relevant citations.
