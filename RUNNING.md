...
- NestJS Server will listen at `ws://localhost:6001`
- Next.js Web App will be available at `http://localhost:6000`
...
```text
[Test Client] Connecting to local proxy at ws://localhost:6001...
